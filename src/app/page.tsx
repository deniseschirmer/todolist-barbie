...
export default function Home() {
  ...
  return (
    <main className="w-screen h-screen flex items-center justify-center bg-[url('../assets/barbie.jpg')] bg-right-top object-fill bg-no-repeat ">
      <div className="bg-pink-400 container max-w-lg p-4 rounded-md flex flex-col gap-6">
        <h1 className="mx-auto text-2xl uppercase font-black">
          To do Barbie Dev{" "}
        </h1>
